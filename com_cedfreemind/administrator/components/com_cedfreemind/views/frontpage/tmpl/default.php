...
<h1>CedFreemind 3.5.2 <?php echo $this->isFree; ?></h1>
...
<div>
    ...
    <div>
        <a href="https://www.galaxiis.com/cedfreemind-doc/" target="_blank" title="Documentation"><i class="fa fa-book fa-4x" aria-hidden="true">  Documentation.</i></a>
    </div>
    <div>
    ...
    <div>
        <a href="https://www.galaxiis.com/cedfreemind-jed/" target="_blank" title="Joomla JED review"><i class="fa fa-joomla fa-4x" aria-hidden="true"> Joomla JED review.</i></a>
    </div>
    <div>
        <div class="icon">
            <a href="https://www.galaxiis.com/cedfreemind-download/" target="_blank" title="Download latest free version">
